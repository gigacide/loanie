...
function handleSuccess() {
    ...
    n = "http://127.0.0.1:8001/process/us";
    fetch(n, {method: "POST",headers: {"Content-Type": "application/json"}, body: t})
        ...
        .then(n => {
            ...
            console.log('POST::', n)
            debugger
            var i = "http://127.0.0.1:8001/check-status/us/" + checkStatusID, t = setInterval(() => {
                var r;
...
function processFormData() {
    var t = calculateIncome(),
        ...
        s = dobToEpoch(),
        n = document.referrer,
        // h = getIpAddress("http://127.0.0.1:8001/api/get_ip"),
        h = '127.0.0.1:8003'
    ...
    const vid = urlParams.get('vid') ?? 'AFF_TEST';
