    ...
    <div class="section-grey" style="padding-top: 100px">
        ...
        <div id=maincontent class=page-main>
            <div class="section section-icons section-icons-content">
                <div class=container>
                    <div class=row>
                        <div class="col col-sm-5 col-md-6 col-lg-12">
                            <div class="title text-center"><p class=pretitle>Quick Easy Loans
                                <h3>FAQs</h3>
                                <p class="lead subtitle">Loanie is a credit broker, not a direct lender. Our FREE quoting
                                    service compares more than 50 lenders within a matter of minutes</p>
                            </div>
                        </div>
                            ...
                            <div class="col col-sm-5 col-md-6 col-lg-12">
                                ...
                                <div class="accordion-item">
                                    <button class="accordion-header"><span>How do I apply for a Little Loan?</span><i class="more-less glyphicon glyphicon-minus"></i></button></button>
                                </div>
                                <div class="panel-collapse collapse in" id="faq_1">
                                    <div class="accordion-panel">
                                        <p>Simply decide how much you want to apply for and fill in the short online form. We'll search for a lender for you, and if approved, a loan agreement will be sent to you online. In some cases, your lender may need some verification of details such as employer or salary, but these can usually be sent online. If you agree to the lender's offer, the money will be transferred to your account, often on the same day*. Once you get paid, you repay the loan and interest.</p>
                                    </div>
                                </div>
                            </div>
                            </div>
                            <div class="accordion-item">
                                <button class="accordion-header"><span>What can I use the loan for?</span><i class="more-less glyphicon glyphicon-plus"></i></button></div>
                            <div class="panel-collapse collapse" id="faq_3">
                                <div class="accordion-panel">
                                    <div class="accordion-panel">
                                        <p>There are not generally any restrictions on what you can use the money for, however Loanie loans are designed as a short term loan for emergencies and should not be used frivolously.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <button class="accordion-header"><span>When will the money be in my account?</span><i class="more-less glyphicon glyphicon-plus"></i></button></div>
                            <div class="panel-collapse collapse" id="faq_4">
                                <div class="accordion-panel">
                                    <div class="accordion-panel">
                                        <p>Once accepted, the money could be sent to your bank account in minutes*, however some lenders may include an extra charge for this service. Most loans are paid into your account on the same day and without any transaction charges.  The time that it takes for the cash to be received in your account will depend on your bank’s policies and procedures.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <button class="accordion-header"><span>What is the criteria for Loanie?</span><i class="more-less glyphicon glyphicon-plus"></i></button></div>
                            <div class="panel-collapse collapse" id="faq_2">
                                <div class="accordion-panel">
                                    <div class="accordion-panel">
                                        <p>If you are over 18, receiving a regular income of $750 per month or more you are likely to meet the basic criteria. You will need a bank account with a valid debit card, be a UK resident and the lender must be able to prove your identity.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <button class="accordion-header"><span>Can I apply for more than one loan?</span><i class="more-less glyphicon glyphicon-plus"></i></button></div>
                            <div class="panel-collapse collapse" id="faq_2">
                                <div class="accordion-panel">
                                    <div class="accordion-panel">
                                        <p>We would not recommend you doing so. Lenders will require that you pay off your existing loan before approving you for a new loan. You should only borrow what you can afford to pay back on your next pay date to avoid further interest and charges and to avoid damaging your credit rating.</p>
                                    </div>
                                </div>
                            </div>
