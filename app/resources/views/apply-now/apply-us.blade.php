...
<body>
    <div id="wrapper">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="section-dark gradient-pink-purple main-menu">
                            <div class="nav">
                                <ul>
                                    <li><a href="{{route('home-us',['affiliate_id'=>$affiliate['affiliate_id'], 'offer_id'=>$affiliate['offer_id'], 'transaction_id'=>'', 'aff_sub'=>$affiliate['aff_sub']])}}">Home</a></li>
                                    <li><a href="{{route('apply-us',['affiliate_id'=>$affiliate['affiliate_id'], 'offer_id'=>$affiliate['offer_id'], 'transaction_id'=>$affiliate['transaction_id'], 'aff_sub'=>$affiliate['aff_sub'], 'aff_sub2'=>$affiliate['aff_sub2'], 'aff_sub3'=>$affiliate['aff_sub3'], 'aff_sub4'=>$affiliate['aff_sub4'], 'aff_sub5'=>$affiliate['aff_sub5']])}}">Get a loan quote</a></li>
                                    <li><a href="{{route('guides',['affiliate_id'=>$affiliate['affiliate_id'], 'offer_id'=>$affiliate['offer_id'], 'transaction_id'=>$affiliate['transaction_id'], 'aff_sub'=>$affiliate['aff_sub'], 'aff_sub2'=>$affiliate['aff_sub2'], 'aff_sub3'=>$affiliate['aff_sub3'], 'aff_sub4'=>$affiliate['aff_sub4'], 'aff_sub5'=>$affiliate['aff_sub5']])}}">How it works</a></li>
                                    <li><a href="{{route('guides',['affiliate_id'=>$affiliate['affiliate_id'], 'offer_id'=>$affiliate['offer_id'], 'transaction_id'=>$affiliate['transaction_id'], 'aff_sub'=>$affiliate['aff_sub'], 'aff_sub2'=>$affiliate['aff_sub2'], 'aff_sub3'=>$affiliate['aff_sub3'], 'aff_sub4'=>$affiliate['aff_sub4'], 'aff_sub5'=>$affiliate['aff_sub5']])}}">FAQs</a></li>
                                    <li><a href="{{route('apply-us',['affiliate_id'=>$affiliate['affiliate_id'], 'offer_id'=>$affiliate['offer_id'], 'transaction_id'=>$affiliate['transaction_id'], 'aff_sub'=>$affiliate['aff_sub'], 'aff_sub2'=>$affiliate['aff_sub2'], 'aff_sub3'=>$affiliate['aff_sub3'], 'aff_sub4'=>$affiliate['aff_sub4'], 'aff_sub5'=>$affiliate['aff_sub5']])}}">Eligibility</a></li>
                                    <li><a href='https://uping.uk'>Affiliates</a></li>
                                    <li><a href="{{route('contact-us',['affiliate_id'=>$affiliate['affiliate_id'], 'offer_id'=>$affiliate['offer_id'], 'transaction_id'=>$affiliate['transaction_id'], 'aff_sub'=>$affiliate['aff_sub'], 'aff_sub2'=>$affiliate['aff_sub2'], 'aff_sub3'=>$affiliate['aff_sub3'], 'aff_sub4'=>$affiliate['aff_sub4'], 'aff_sub5'=>$affiliate['aff_sub5']])}}">Contact us</a></li>
                                    <li><a href="{{route('complaints',['affiliate_id'=>$affiliate['affiliate_id'], 'offer_id'=>$affiliate['offer_id'], 'transaction_id'=>$affiliate['transaction_id'], 'aff_sub'=>$affiliate['aff_sub'], 'aff_sub2'=>$affiliate['aff_sub2'], 'aff_sub3'=>$affiliate['aff_sub3'], 'aff_sub4'=>$affiliate['aff_sub4'], 'aff_sub5'=>$affiliate['aff_sub5']])}}">Complaints</a></li>
                                    <li><a href="{{route('privacy',['affiliate_id'=>$affiliate['affiliate_id'], 'offer_id'=>$affiliate['offer_id'], 'transaction_id'=>$affiliate['transaction_id'], 'aff_sub'=>$affiliate['aff_sub'], 'aff_sub2'=>$affiliate['aff_sub2'], 'aff_sub3'=>$affiliate['aff_sub3'], 'aff_sub4'=>$affiliate['aff_sub4'], 'aff_sub5'=>$affiliate['aff_sub5']])}}">Avoid Scams</a></li>
                                </ul>
                            </div>
                        </div>
        ...
        <form class="test" id="uPingForm" name="uPingForm" novalidate>
            ...
            <input type="hidden" id="aff_sub" name="aff_sub" value="{{$affiliate['aff_sub']}}">
            <input type="hidden" id="aff_sub2" name="aff_sub2" value="{{$affiliate['aff_sub2']}}">
            <input type="hidden" id="aff_sub3" name="aff_sub3" value="{{$affiliate['aff_sub3']}}">
            <input type="hidden" id="aff_sub4" name="aff_sub4" value="{{$affiliate['aff_sub4']}}">
            <input type="hidden" id="aff_sub5" name="aff_sub5" value="{{$affiliate['aff_sub5']}}">
                            ...
                            <div class="col col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                                ...
                                <div class="form-container" >
                                    ...
                                    <div class="form-group" id="bank_sortcode">
                                        ...
                                        <input class="form-control" id="sortcode" name="Bank_sort_code" type="tel">
                                    ...
                                    <div class="form-group" id="bank_account_type">
                                        ...
                                        <div class="form-choice radio-class radio-large">
                                            <div class="field-choice">
                                                <input id="vdebit" name="radio_primary_card" type="radio" value="5">
                                                <label class="form-control transition" for="vdebit">Checking</label>
                                            </div>
                                            <div class="field-choice">
                                                <input id="vdelta" name="radio_primary_card" type="radio" value="6">
...
<div class="finalization section section-form">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col col-sm-3 footer-top-left">
                            <div class="">
                                <span class=""><img  height="170" style="height:60px"
                        ...
                        <div class="col col-sm-9 footer-top-right">
                            <a href="{{route('apply-us')}}" class="btn btn-default">Get a loan quote</a>
                            <a href="{{route('apply-us')}}" class="btn btn-primary">Am I eligible</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            // $('#nextPayDate').on('input', function() {
            //     // var nextPayDate = $(this).val().replace(/[-\/\\^$*+?.()|[\]{}]/g, ''); // remove any slashes and hyphens
            //     // var messages = $('.messages');
            //     const nextPayDateError = document.getElementById('next_pay_date_error');
            //
            //     var pattern = /^(0?[1-9]|1[0-2])\/(0?[1-9]|[12]\d|3[01])\/\d{4}$/; // pattern to match Social Security Number
            //
            //     if (!pattern.test(nextPayDate)) {
            //         nextPayDateError.innerHTML = '<span class="text-danger">Invalid Next Pay Date MM/DD/YYYY</span>';
            //         $(this).addClass('form-group has-error');
            //     } else {
            //         nextPayDateError.innerHTML = '<span class="text-danger"></span>';
            //         $(this).removeClass('form-group has-error');
            //     }
            // });
            //
            // $('#followingPayDate').on('input', function() {
            //     // var followingPayDate = $(this).val().replace(/[-\/\\^$*+?.()|[\]{}]/g, ''); // remove any slashes and hyphens
            //     // var messages = $('.messages');
            //     const followingPayDateError = document.getElementById('following_pay_date_error');
            //
            //     var pattern = /^(0?[1-9]|1[0-2])\/(0?[1-9]|[12]\d|3[01])\/\d{4}$/; // pattern to match Social Security Number
            //
            //     if (!pattern.test(followingPayDate)) {
            //         followingPayDateError.innerHTML = '<span class="text-danger">Invalid Following Pay Date MM/DD/YYYY</span>';
            //         $(this).addClass('form-group has-error');
            //     } else {
            //         followingPayDateError.innerHTML = '<span class="text-danger"></span>';
            //         $(this).removeClass('form-group has-error');
            //     }
            // });
            ...
            $('#ssn').on('input', function() {
                var ssn = $(this).val().replace(/[-\/\\^$*+?.()|[\]{}]/g, ''); // remove any slashes and hyphens
                // var messages = $('.messages');
                const ssnError = document.getElementById('ssn_error');

                var pattern = /^\d{9}$/; // pattern to match Social Security Number

                if (!pattern.test(ssn)) {
                    ssnError.innerHTML = '<span class="text-danger">Invalid Social Security Number</span>';
                    $(this).addClass('form-group has-error');
                } else {
                    ssnError.innerHTML = '<span class="text-danger"></span>';
                    $(this).removeClass('form-group has-error');
                }
            });

            $('#drivingLicenseNumber').on('input', function() {
                var drivingLicenseNumber = $(this).val().replace(/[-\/\\^$*+?.()|[\]{}]/g, ''); // remove any slashes and hyphens
                // var messages = $('.messages');
                const drivingLicenseNumberError = document.getElementById('drivingLicenseNumberError');

                var pattern = /^[A-Z]{1}[A-Z0-9]{1,20}$/; // pattern to match drivingLicenseNumber

                if (!pattern.test(drivingLicenseNumber)) {
                    drivingLicenseNumberError.innerHTML = '<span class="text-danger">Invalid Driving License Number</span>';
                    $(this).addClass('form-group has-error');
                } else {
                    drivingLicenseNumberError.innerHTML = '<span class="text-danger"></span>';
                    $(this).removeClass('form-group has-error');
                }
            ...
            $('#postcode').on('input', function() {
                var postcode = $(this).val().replace(/[-\/\\^$*+?.()|[\]{}]/g, ''); // remove any slashes and hyphens
                // var messages = $('.messages');
                const postcodeError = document.getElementById('postcodeError');

                var pattern = /^\d{5}$/; // pattern to match drivingLicenseNumber

                if (!pattern.test(postcode)) {
                    postcodeError.innerHTML = '<span class="text-danger">Invalid ZIP Code</span>';
                    $(this).addClass('form-group has-error');
                } else {
                    postcodeError.innerHTML = '<span class="text-danger"></span>';
                    $(this).removeClass('form-group has-error');
                }
            ...
            $('#accountnumber').on('input', function() {
                var accountnumber = $(this).val().replace(/[-\/\\^$*+?.()|[\]{}]/g, ''); // remove any slashes and hyphens
                // var messages = $('.messages');
                const bankAccountNumberError = document.getElementById('bankAccountNumberError');

                var pattern = /^\d{6,17}$/; // pattern to match drivingLicenseNumber

                if (!pattern.test(accountnumber)) {
                    bankAccountNumberError.innerHTML = '<span class="text-danger">Invalid Bank Account Number</span>';
                    $(this).addClass('form-group has-error');
                } else {
                    bankAccountNumberError.innerHTML = '<span class="text-danger"></span>';
                    $(this).removeClass('form-group has-error');
                }
            });

            $('#sortcode').on('input', function() {
                var sortcode = $(this).val().replace(/[-\/\\^$*+?.()|[\]{}]/g, ''); // remove any slashes and hyphens
                // var messages = $('.messages');
                const bankRoutingNumberError = document.getElementById('bankRoutingNumberError');

                var pattern = /^\d{9}$/; // pattern to match drivingLicenseNumber

                if (!pattern.test(sortcode)) {
                    bankRoutingNumberError.innerHTML = '<span class="text-danger">Invalid Bank Routing Number</span>';
                    $(this).addClass('form-group has-error');
                } else {
                    bankRoutingNumberError.innerHTML = '<span class="text-danger"></span>';
                    $(this).removeClass('form-group has-error');
            ...
            $('#mobilephone').on('input', function() {
                ...
                // Retrieve input value and remove any non-digit characters
                const mobilephone = $(this).val();
                const cleanedPhoneNumber = mobilephone.replace(/\D/g, '');

                if (regex.test(cleanedPhoneNumber)) {
                    mobilephoneError.innerHTML = '<span class="text-danger"></span>';
                    $(this).parent().addClass('has-success').removeClass('has-error');
                } else {
                    mobilephoneError.innerHTML = '<span class="text-danger">Invalid Mobile Phone Number</span>';
            ...
            $('#homePhone').on('input', function() {
                ...
                // Retrieve input value and remove any non-digit characters
                const homePhone = $(this).val();
                const cleanedPhoneNumber = homePhone.replace(/\D/g, '');

                if (regex.test(cleanedPhoneNumber)) {
                    homePhoneError.innerHTML = '<span class="text-danger"></span>';
                    $(this).parent().addClass('has-success').removeClass('has-error');
                } else {
                    homePhoneError.innerHTML = '<span class="text-danger">Invalid Home Phone Number</span>';
                    $(this).parent().addClass('has-error').removeClass('has-success');
                }
            });
            $('#workPhone').on('input', function() {
                const workPhoneError = document.getElementById('workPhoneError');
                const regex = /^(?:\+1|1)?[-.\s]?\(?\d{3}\)?[-.\s]?\d{3}[-.\s]?\d{4}$/;

                // Retrieve input value and remove any non-digit characters
                const workPhone = $(this).val();
                const cleanedPhoneNumber = workPhone.replace(/\D/g, '');

                if (regex.test(cleanedPhoneNumber)) {
                    workPhoneError.innerHTML = '<span class="text-danger"></span>';
                    $(this).parent().addClass('has-success').removeClass('has-error');
                } else {
                    workPhoneError.innerHTML = '<span class="text-danger">Invalid Work Phone Number</span>';
                    $(this).parent().addClass('has-error').removeClass('has-success');
                }
            });
...
{{--            mf.src = "//cdn.mouseflow.com/projects/b1ad71c3-42a0-4274-bbd0-fb5d10b33ee3.js";--}}
