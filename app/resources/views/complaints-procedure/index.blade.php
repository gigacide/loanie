        ...
        <div id=maincontent class=page-main>
            <div class="section section-icons section-icons-content">
                <div class=container>
                    <div class=row>
                        <div class="">
                            <div class="title text-left"><p class=pretitle>How to make a complaint
                                <h3>Complaints</h3>
                            ...
                            <p class="lead subtitle">
                                ...
                                If you have a complaint </p>
                            <p class="lead subtitle">

                                If you have a complaint about any aspect of our service, then we would like to hear from you. You can contact us in writing at Loanie. 71-75 Shelton Street, London, UK, WC2H 9QJ or via our contact form
