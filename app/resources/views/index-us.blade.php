...
<div id=wrapper>
    <div id=header>
        <div class=h-top>
            ...
            <div class=fraud-warning><strong>Avoid Scams</strong> Recognize the signs of online scams <a
                    href={{route('keep_safe_from_scammers')}}>See More</a></div>
        </div>
        <div class=header>
            <div class=container>
                <div class=row>
    ...
    <div class="section-grey home-banner">
        <div class=container>
            <div class=row>
                <div class="col col-sm-8 col-lg-7">
                    <div class=home-banner-content><h1>Borrow what you need, for as long as you need</h1>
                        <p class=h4>Instant Loan Quote
                        <div class=quote-form>
                            {{--                            <form method=get action="{{route('apply-us',['affiliate_id'=>$affiliate['affiliate_id'], 'offer_id'=>$affiliate['offer_id'], 'transaction_id'=>$affiliate['transaction_id'], 'aff_sub'=>$affiliate['aff_sub'], 'aff_sub2'=>$affiliate['aff_sub2'], 'aff_sub3'=>$affiliate['aff_sub3'], 'aff_sub4'=>$affiliate['aff_sub4'], 'aff_sub5'=>$affiliate['aff_sub5']])}}"e>--}}
                            <div class=loan-details>
                                <div class=loan-amount>
                                    <div class=form-group><label>Loan amount</label>
                                        <div class=loan-amount-input><span class="currency-symbol currency-shim">&dollar;</span><input
                                                id=loanamount-shim name=la type=tel
                                                class="form-control loan-amount-input" value=1500> <a href=#
                                ...
                                <div class=loan-months>
                                    <div class=form-group><label>Months</label>
                                        <div class="form-choice loan-months-input">
                                            <div class=field-choice><input id=field-choice-0-3 name=term value=3
                                                                           type=radio> <label for=field-choice-0-3
                                                                                              class="form-control transition">3</label>
                                            </div>
                                            <div class=field-choice><input id=field-choice-0-6 name=term value=6
                                                                           type=radio> <label for=field-choice-0-6
                                                                                              class="form-control transition">6</label>
                                            </div>
                                            <div class=field-choice><input id=field-choice-0-12 name=term value=12
                                                                           type=radio> <label for=field-choice-0-12
                                                                                              class="form-control transition">12</label>
                                            </div>
                                            <div class=field-choice><input id=field-choice-0-18 name=term value=18
                                                                           type=radio> <label for=field-choice-0-18
                                                                                              class="form-control transition">18</label>
                                            </div>
                                            <div class=field-choice><input id=field-choice-0-24+ name=term value=24
                                                                           type=radio> <label for=field-choice-0-24+
                                                                                              class="form-control transition">24+</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="box box-border">
                                ...
                                <p style="color:#757575 !important" class=fca-emphasis><span style=font-weight:700>Loanie is a registered trading name Stag Finance Ltd who is a credit broker, not a lender</span>.
                        ...
                        <div class="mobile fraud-warning"><strong>Avoid Scams</strong> Recognize the signs of online
                            scams <a href=keep_safe_from_scammers.html>See More</a></div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col col-sm-7 col-md-7 col-lg-offset-1">
                        <div class=icon-blocks>
                            <div class=icon-block>
                                <div class="box icon-block-image"><img class=lazy
                                                                       data-src=Content/Images/icon-fill-application.png>
                                </div>
                                <div class=icon-block-content><h5>Fill in our easy online application</h5>
                                    <p>It only takes minutes to complete, and all credit types will be considered</div>
                            </div>
                            <div class=icon-block>
                                <div class="box icon-block-image"><img class=lazy
                                                                       data-src=/Content/Images/icon-instant-decision.png>
                                </div>
                                <div class=icon-block-content><h5>We’ll provide an instant quote</h5>
                                    <p>Once a match is found, you will be presented with your no obligation offer</div>
                            </div>
                            <div class=icon-block>
                                <div class="box icon-block-image"><img class=lazy
                                                                       data-src=/Content/Images/icon-e-sign.png></div>
                                <div class=icon-block-content><h5>e-Sign your agreement &amp; receive your funds</h5>
                                    <p>Loan funds can be deposited direct to your bank quickly</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col col-sm-12">
                        <div class="footer-links divider-line">
                            <ul>
                                ...
                                <li>
                                    <a href="{{route('apply-us',['affiliate_id'=>$affiliate['affiliate_id'], 'offer_id'=>$affiliate['offer_id'], 'transaction_id'=>$affiliate['transaction_id'], 'aff_sub'=>$affiliate['aff_sub'], 'aff_sub2'=>$affiliate['aff_sub2'], 'aff_sub3'=>$affiliate['aff_sub3'], 'aff_sub4'=>$affiliate['aff_sub4'], 'aff_sub5'=>$affiliate['aff_sub5']])}}">Eligibility</a>
                                <li><a href="{{route('affiliates')}}">Affiliates</a>
                                <li>
                                    <a href="{{route('contact-us',['affiliate_id'=>$affiliate['affiliate_id'], 'offer_id'=>$affiliate['offer_id'], 'transaction_id'=>$affiliate['transaction_id'], 'aff_sub'=>$affiliate['aff_sub'], 'aff_sub2'=>$affiliate['aff_sub2'], 'aff_sub3'=>$affiliate['aff_sub3'], 'aff_sub4'=>$affiliate['aff_sub4'], 'aff_sub5'=>$affiliate['aff_sub5']])}}">Contact
                                        us</a>
                                <li>
...
{{--<script src="../bundles/scripts8f71"></script>--}}
