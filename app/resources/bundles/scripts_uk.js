...
var getUrl = window.location, baseUrl = getUrl.protocol + "//" + getUrl.host + "/" + getUrl.pathname.split("/")[1],
    pingyo = {
        iframeSrc: "https://apply.http://127.0.0.1:8000/",
        mobileFormSrc: "https://apply.http://127.0.0.1:8000",
        defaultAffiliate: "UPING",
        ...
        cookieExpiryTime: 1,
        getValue: function (n) {
            var t = jQuery.parseJSON(pingyo.readCookie()), i;
            if (t !== undefined && t !== null) for (i in t) if (i === n) return t[i];
            return null
        },
        setAffiliateId: function (n) {
            pingyo.defaultAffiliate = n === undefined || n === null || n.length < 1 ? "UPING" : n
        },
        setSubAffiliate: function (n) {
            pingyo.defaultSubAffiliate = n === undefined || n === null || n.length < 1 ? null : n
        },
        setCampaign: function (n) {
            pingyo.defaultCampaign = n === undefined || n === null || n.length < 1 ? null : n
        },
        setValue: function (n, t) {
            var r = !1, i = jQuery.parseJSON(pingyo.readCookie()), u;
            if (i !== undefined && i !== null) for (u in i) u === n && (i[n] = t, r = !0);
            r || ((i === undefined || i === null) && (i = {}), i[n] = t);
            pingyo.createCookie(i)
        },
        buildIframeApplyLink: function () {
            var e = pingyo.getUrlVars(), n = [], o = [], t, i, r, u, f, s;
            n.id = pingyo.defaultAffiliate;
            n.subid = pingyo.defaultSubAffiliate === null ? "" : pingyo.defaultSubAffiliate;
            n.campaign = pingyo.defaultCampaign === null ? "" : pingyo.defaultCampaign;
            t = jQuery.parseJSON(pingyo.readCookie());
            for (i in t) n[i] = t[i];
            for (r in e) n[r] = e[r];
            u = 0;
        ...
        getVisitCookieName: function () {
            return pingyo.defaultAffiliate + "-visit"
        },
        createVisitCookie: function () {
            return document.cookie = pingyo.getVisitCookieName() + "=1;path=/"
        },
        createCookie: function (n) {
            var t = pingyo.readCookie(), u, i, r;
            t = t === null ? {} : jQuery.parseJSON(t);
            for (u in n) t[u] = n[u];
            i = JSON.stringify(t);
            pingyo.cookieExpiryTime < 1 || pingyo.cookieExpiryTime === undefined ? document.cookie = "AffPop=" + escape(i) + ";path=/" : (r = new Date, r.setTime(r.getTime() + pingyo.cookieExpiryTime * 36e5), document.cookie = "AffPop=" + escape(i) + ";expires=" + r.toGMTString() + ";path=/");
            pingyo.readCookie() || (document.cookie = "AffPop=" + escape(i))
        },
        ...
        mobileliseLinkUrls: function () {
            ...
            $("a.mobile-apply").length && (t = pingyo.buildMobileApplyLink(), i = "&", t.indexOf("?") === -1 && (i = "?"), n = pingyo.mobileFormSrc + t + i + "mobile=on&bannerurl=", console.log(pingyo.mobileFormSrc + t + i + "mobile=on&bannerurl="), pingyo.mobileBannerImage !== undefined && pingyo.mobileBannerImage !== null && (n = n + encodeURI(pingyo.mobileBannerImage) + "&la=" + u + "&term=" + f), $("a.mobile-apply").attr("href", n), $("a.mobile-apply").attr("rel") || $("a.mobile-apply").attr("rel", "nofollow"));
            r && (window.location.href = n)
        },
        configureIframe: function () {
            var n, t, i;
            $("iframe.applyForm").length && (n = pingyo.buildIframeApplyLink(), t = "", pingyo.detectMobile && (/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|ipad|iris|kindle|Android|Silk|lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(navigator.userAgent) || /1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(navigator.userAgent.substr(0, 4))) && (t = n === null || n === undefined || n.indexOf("?") < 0 ? "?mobile=on" : "&mobile=on"), i = pingyo.iframeSrc + n + t, $("iframe.applyForm").attr("src", i))
        }
    }, cookies;
$(function () {
    var n = pingyo.getUrlVars();
    n && (pingyo.createCookie(n), cookies = JSON.parse(pingyo.readCookie()), cookies && (pingyo.setAffiliateId(cookies.id), pingyo.setCampaign(cookies.campaign), pingyo.setSubAffiliate(cookies.subid)), console.log(cookies), console.log(pingyo.defaultAffiliate), console.log(pingyo.defaultCampaign), console.log(pingyo.defaultSubAffiliate));
    pingyo.defaultSiteAffiliate !== undefined && pingyo.defaultSiteAffiliate !== null && pingyo.defaultSiteAffiliate.length > 0 && pingyo.setAffiliateId(defaultSiteAffiliate);
    pingyo.defaultSiteCampaign !== undefined && pingyo.defaultSiteCampaign !== null && pingyo.defaultSiteCampaign.length > 0 && pingyo.setCampaign(defaultSiteCampaign);
    pingyo.defaultSiteSubAffiliate !== undefined && defaultSiteSubAffiliate !== null && pingyo.defaultSiteSubAffiliate.length > 0 && pingyo.setSubAffiliate(defaultSiteSubAffiliate)
});
