...
class LoanApplicationValidation
{
    ...
    {
        // Define validation rules for various fields in the loan application form
        $rules = [
        ...
        // Additional date formatting for date fields

        // Format the nextPayDate and followingPayDate fields as "DD-MM-YYYY" before validating
