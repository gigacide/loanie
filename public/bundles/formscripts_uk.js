...
function handleSuccess() {
    ...
    n = "http://127.0.0.1:8000/process/uk";
    fetch(n, {method: "POST",headers: {"Content-Type": "application/json"}, body: t})
        ...
        .then(n => {
            ...
            console.log('POST::', n)
            debugger
            var i = "http://127.0.0.1:8000/check-status/uk/" + checkStatusID, t = setInterval(() => {
                var r;
...
function processFormData() {
    var t = calculateIncome(), r = calculateBank(), u = calculateMoveIn(),
        ...
        s = dobToEpoch(),
        n = document.referrer,
        // h = getIpAddress("https://www.uping.uk/geo/echo/ip"),
        h = "127.0.0.1:1337",
        c = getLoanProceedUse(),
    ...
    if (!l) throw"Affiliate Id not detected. Fallback to PINGU THE PENGUIN";
    return cookies && cookies.gclid && (n = appendQueryParams(n, "gclid", cookies.gclid)), i = {
        ...
        expense: {
            utilitiesExpense: Number(document.getElementById("utilities").value),
            ...
            transportExpense: Number(document.getElementById("transport").value),
...
function processFormDataSpecialOffer() {
    var t = calculateIncome(), r = calculateBank(), u = calculateMoveIn(),
        ...
        e = document.getElementById("jobtitle").value.length > 0 ? document.getElementById("jobtitle").value : "Unemployed",
        o = document.getElementById("employmentindustry").value.length > 0 ? Number(document.getElementById("employmentindustry").value) : 12,
        s = dobToEpoch(), n = document.referrer,
        // h = getIpAddress("https://www.uping.uk/geo/echo/ip"),
        c = getLoanProceedUse(), i;
    return cookies && cookies.gclid && (n = appendQueryParams(n, "gclid", cookies.gclid)), i = {
        Campaign: uping.defaultCampaign,
        AffiliateId: uping.defaultAffiliate,
        SubAffiliate: uping.defaultSubAffiliate,
        Timeout: 0,
        TestOnly: !1,
        Application: {
